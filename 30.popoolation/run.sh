...
perl ../popoolation2_1201/mpileup2sync.pl --fastq-type sanger  --input ../20.mpileup_/Pool1.mpileup  --output Pool1.sync --min-qual 20
perl ../popoolation2_1201/mpileup2sync.pl --fastq-type sanger  --input ../20.mpileup_/Pool2.mpileup  --output Pool2.sync --min-qual 20
